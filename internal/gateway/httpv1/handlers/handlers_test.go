...
func TestListRates(t *testing.T) {
	...
	t.Run("200 with rates", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/sources/src1/rates", nil)
	...
	t.Run("400 when name path param missing", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.ListRates(rr, httptest.NewRequest(http.MethodGet, "/api/v1/sources//rates", nil))
...
func TestListHistory(t *testing.T) {
	...
	t.Run("200 with records", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/sources/src1/history", nil)
		req.SetPathValue("name", "src1")
		rr := httptest.NewRecorder()
...
func TestListPendingEvents(t *testing.T) {
	...
	t.Run("200 with pending events", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.ListPendingEvents(rr, httptest.NewRequest(http.MethodGet, "/api/v1/events/pending", nil))
...
func TestListSourceFailedEvents(t *testing.T) {
	...
	t.Run("200 with failed events, user_id absent", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/sources/src1/events/failed?page=1", nil)
		req.SetPathValue("name", "src1")
		rr := httptest.NewRecorder()
	...
	t.Run("400 when name missing", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.ListSourceFailedEvents(rr, httptest.NewRequest(http.MethodGet, "/api/v1/sources//events/failed", nil))
		require.Equal(t, http.StatusBadRequest, rr.Code)
	})
	...
	t.Run("500 on error", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/sources/src1/events/failed", nil)
		req.SetPathValue("name", "src1")
		rr := httptest.NewRecorder()
		h.ListSourceFailedEvents(rr, req)
...
func TestListSourceSubscriptions(t *testing.T) {
	...
	t.Run("200 with subscription summaries", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/sources/src1/subscriptions", nil)
		req.SetPathValue("name", "src1")
		rr := httptest.NewRecorder()
	...
	t.Run("400 when name missing", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.ListSourceSubscriptions(rr, httptest.NewRequest(http.MethodGet, "/api/v1/sources//subscriptions", nil))
		require.Equal(t, http.StatusBadRequest, rr.Code)
	})
...
func TestHandler_ToggleSourceActive(t *testing.T) {
	...
	t.Run("204 on success", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodPatch, "/api/v1/sources/src1/active", strings.NewReader(`{"active":true}`))
		req.SetPathValue("name", "src1")
		rr := httptest.NewRecorder()
	...
	t.Run("404 when source not found", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodPatch, "/api/v1/sources/unknown/active", strings.NewReader(`{"active":true}`))
	...
	t.Run("400 on malformed request body", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodPatch, "/api/v1/sources/src1/active", strings.NewReader(`not-json`))
		req.SetPathValue("name", "src1")
		rr := httptest.NewRecorder()
		h.ToggleSourceActive(rr, req)
	...
	t.Run("400 when name path param missing", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.ToggleSourceActive(rr, httptest.NewRequest(http.MethodPatch, "/api/v1/sources//active", strings.NewReader(`{"active":true}`)))
...
func TestHandler_ListStats(t *testing.T) {
	...
	t.Run("200 with stats", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.ListStats(rr, httptest.NewRequest(http.MethodGet, "/api/v1/stats", nil))
...
func TestHandler_ListSourceSubscriptionDetails(t *testing.T) {
	...
	t.Run("200 with subscription details", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/sources/src1/subscriptions/list?page=1", nil)
		req.SetPathValue("name", "src1")
		rr := httptest.NewRecorder()
	...
	t.Run("400 when name path param missing", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.ListSourceSubscriptionDetails(rr, httptest.NewRequest(http.MethodGet, "/api/v1/sources//subscriptions/list", nil))
	...
	t.Run("500 on error", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/sources/src1/subscriptions/list", nil)
		req.SetPathValue("name", "src1")
		rr := httptest.NewRecorder()
		h.ListSourceSubscriptionDetails(rr, req)
...
func TestHandler_ListSourceDailyEvents(t *testing.T) {
	...
	t.Run("200 with daily event summaries", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/sources/src1/events/daily?page=1", nil)
		req.SetPathValue("name", "src1")
		rr := httptest.NewRecorder()
	...
	t.Run("400 when name path param missing", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.ListSourceDailyEvents(rr, httptest.NewRequest(http.MethodGet, "/api/v1/sources//events/daily", nil))
	...
	t.Run("500 on error", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/sources/src1/events/daily", nil)
		req.SetPathValue("name", "src1")
		rr := httptest.NewRecorder()
		h.ListSourceDailyEvents(rr, req)
...
func TestHandler_ListExecutionErrors(t *testing.T) {
	...
	t.Run("200 with execution errors", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.ListExecutionErrors(rr, httptest.NewRequest(http.MethodGet, "/api/v1/errors/execution?page=1", nil))
	...
	t.Run("200 empty array on page with no records", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.ListExecutionErrors(rr, httptest.NewRequest(http.MethodGet, "/api/v1/errors/execution?page=99", nil))
	...
	t.Run("500 on error", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.ListExecutionErrors(rr, httptest.NewRequest(http.MethodGet, "/api/v1/errors/execution", nil))
...
func TestHandler_ListMeSubscriptions(t *testing.T) {
	...
	t.Run("search filters by source title", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/me/subscriptions?q=euro", nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		rr := httptest.NewRecorder()
		h.ListMeSubscriptions(rr, withCaller(req, callerUserID))
	...
	t.Run("paginates correctly for 12 subscriptions on page 2", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/me/subscriptions?page=2&page_size=10", nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		rr := httptest.NewRecorder()
		h.ListMeSubscriptions(rr, withCaller(req, callerUserID))
...
func TestHandler_UpsertMeProfile(t *testing.T) {
	...
	t.Run("400 on empty timezone", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodPost, "/api/v1/me/profile",
	...
	t.Run("400 when locale exceeds 64 chars", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodPost, "/api/v1/me/profile", strings.NewReader(body))
		req.Header.Set("X-Telegram-Init-Data", "fake")
		rr := httptest.NewRecorder()
		h.UpsertMeProfile(rr, withCaller(req, callerUserID))
		require.Equal(t, http.StatusBadRequest, rr.Code)
...
func TestGetMeRatesChart(t *testing.T) {
	...
	t.Run("service error returns 500 with fallback message", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/me/rates/chart", nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		rr := httptest.NewRecorder()
	...
	t.Run("explicit period=30 yields Window 30 days", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/me/rates/chart?period=30", nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		rr := httptest.NewRecorder()
		h.GetMeRatesChart(rr, withCaller(req, 1))
	...
	t.Run("invalid integer period returns 400", func(t *testing.T) {
		...
		for _, bad := range []string{"45", "-1", "0", "361"} {
			...
			t.Run(bad, func(t *testing.T) {
				t.Parallel()
				req := httptest.NewRequest(http.MethodGet, "/api/v1/me/rates/chart?period="+bad, nil)
				req.Header.Set("X-Telegram-Init-Data", "valid")
				rr := httptest.NewRecorder()
				h.GetMeRatesChart(rr, withCaller(req, 1))
				require.Equal(t, http.StatusBadRequest, rr.Code)
	...
	t.Run("non-integer period returns 400", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/me/rates/chart?period=7d", nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		rr := httptest.NewRecorder()
		h.GetMeRatesChart(rr, withCaller(req, 1))
		require.Equal(t, http.StatusBadRequest, rr.Code)
	...
	t.Run("empty period value defaults to 7", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/me/rates/chart?period=", nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		rr := httptest.NewRecorder()
		h.GetMeRatesChart(rr, withCaller(req, 1))
		require.Equal(t, http.StatusOK, rr.Code)
	...
	t.Run("effective_days round-trips through GetMeRatesChart", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodGet, "/api/v1/me/rates/chart?period=360", nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		rr := httptest.NewRecorder()
		h.GetMeRatesChart(rr, withCaller(req, 1))
...
func TestGetPublicRatesChart(t *testing.T) {
	...
	t.Run("no period param defaults to 7 days window", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.GetPublicRatesChart(rr, httptest.NewRequest(http.MethodGet, "/api/v1/public/rates/chart", nil))
	...
	t.Run("explicit period=90 yields Window 90 days", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.GetPublicRatesChart(rr, httptest.NewRequest(http.MethodGet, "/api/v1/public/rates/chart?period=90", nil))
	...
	t.Run("invalid period returns 400", func(t *testing.T) {
		...
		for _, bad := range []string{"45", "7d", "-1"} {
			...
			t.Run(bad, func(t *testing.T) {
				t.Parallel()
				rr := httptest.NewRecorder()
				h.GetPublicRatesChart(rr, httptest.NewRequest(http.MethodGet, "/api/v1/public/rates/chart?period="+bad, nil))
				require.Equal(t, http.StatusBadRequest, rr.Code)
				require.Contains(t, rr.Body.String(), "period must be one of 7, 30, 90, 180, 360")
			})
		}
	...
	t.Run("empty period defaults to 7", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.GetPublicRatesChart(rr, httptest.NewRequest(http.MethodGet, "/api/v1/public/rates/chart?period=", nil))
	...
	t.Run("page greater than 1 is forwarded", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.GetPublicRatesChart(rr, httptest.NewRequest(http.MethodGet, "/api/v1/public/rates/chart?page=2", nil))
	...
	t.Run("limit cap clamps to 100", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.GetPublicRatesChart(rr, httptest.NewRequest(http.MethodGet, "/api/v1/public/rates/chart?limit=999", nil))
	...
	t.Run("non-integer limit returns 400", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.GetPublicRatesChart(rr, httptest.NewRequest(http.MethodGet, "/api/v1/public/rates/chart?limit=abc", nil))
	...
	t.Run("page overflow is clamped", func(t *testing.T) {
		...
		rr := httptest.NewRecorder()
		h.GetPublicRatesChart(rr, httptest.NewRequest(http.MethodGet, "/api/v1/public/rates/chart?page=9223372036854775807", nil))
...
func TestHandler_GetMeRatesHistory(t *testing.T) {
	...
	t.Run("200 OK with valid initData and pair", func(t *testing.T) {
		...
		h := newH(t, svc)
		req := httptest.NewRequest(http.MethodGet, "/api/v1/me/rates/history?pair=USD/KZT", nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		rr := httptest.NewRecorder()
	...
	t.Run("400 when pair missing", func(t *testing.T) {
		t.Parallel()
		h := newH(t, &mockMeChartService{history: emptyHistoryResult})
		req := httptest.NewRequest(http.MethodGet, "/api/v1/me/rates/history", nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		rr := httptest.NewRecorder()
		h.GetMeRatesHistory(rr, withCaller(req, 42))
	...
	t.Run("400 when pair is whitespace only", func(t *testing.T) {
		t.Parallel()
		h := newH(t, &mockMeChartService{history: emptyHistoryResult})
		req := httptest.NewRequest(http.MethodGet, "/api/v1/me/rates/history?pair=+++", nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		rr := httptest.NewRecorder()
		h.GetMeRatesHistory(rr, withCaller(req, 42))
	...
	t.Run("400 when limit not a number", func(t *testing.T) {
		t.Parallel()
		h := newH(t, &mockMeChartService{history: emptyHistoryResult})
		req := httptest.NewRequest(http.MethodGet, "/api/v1/me/rates/history?pair=USD/KZT&limit=abc", nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		rr := httptest.NewRecorder()
		h.GetMeRatesHistory(rr, withCaller(req, 42))
	...
	t.Run("limit clamped to max", func(t *testing.T) {
		t.Parallel()
		h := newH(t, &mockMeChartService{history: emptyHistoryResult})
		req := httptest.NewRequest(http.MethodGet, "/api/v1/me/rates/history?pair=USD/KZT&limit=9999", nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		rr := httptest.NewRecorder()
		h.GetMeRatesHistory(rr, withCaller(req, 42))
	...
	t.Run("page defaults to 1 when absent or invalid", func(t *testing.T) {
		t.Parallel()
		h := newH(t, &mockMeChartService{history: emptyHistoryResult})
		req := httptest.NewRequest(http.MethodGet, "/api/v1/me/rates/history?pair=USD/KZT&page=bad", nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		rr := httptest.NewRecorder()
		h.GetMeRatesHistory(rr, withCaller(req, 42))
	...
	t.Run("forwards source_title to service", func(t *testing.T) {
		...
		h := newH(t, svc)
		req := httptest.NewRequest(http.MethodGet, "/api/v1/me/rates/history?pair=USD/KZT&source_title=Kaspi", nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		rr := httptest.NewRecorder()
		h.GetMeRatesHistory(rr, withCaller(req, 42))
	...
	t.Run("equity row Last and LastDeltaPct reach JSON and Bid Ask are nil", func(t *testing.T) {
		...
		h := newH(t, svc)
		req := httptest.NewRequest(http.MethodGet, "/api/v1/me/rates/history?pair=AAPL/USD", nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		rr := httptest.NewRecorder()
		h.GetMeRatesHistory(rr, withCaller(req, 42))
...
func TestHandler_ListMeSubscriptionsRaw(t *testing.T) {
	...
	t.Run("200 empty items when user has no subscriptions", func(t *testing.T) {
		t.Parallel()
		h := newTestHandler(t, Config{})
		req := httptest.NewRequest(http.MethodGet, "/api/v1/me/subscriptions/raw", nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		rr := httptest.NewRecorder()
...
func TestHandler_CreateMeSubscription(t *testing.T) {
	...
	newReq := func(body string) *http.Request {
		req := httptest.NewRequest(http.MethodPost, "/api/v1/me/subscriptions", strings.NewReader(body))
		req.Header.Set("X-Telegram-Init-Data", "valid")
...
func TestHandler_UpdateMeSubscription(t *testing.T) {
	...
	newReq := func(id, body string) *http.Request {
		req := httptest.NewRequest(http.MethodPatch, "/api/v1/me/subscriptions/"+id, strings.NewReader(body))
		req.Header.Set("X-Telegram-Init-Data", "valid")
		req.Header.Set("Content-Type", "application/json")
	...
	t.Run("400 on body exceeding 4 KiB", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodPatch, "/api/v1/me/subscriptions/sub-001", strings.NewReader(bigBody))
		req.Header.Set("X-Telegram-Init-Data", "valid")
		req.Header.Set("Content-Type", "application/json")
...
func TestHandler_DeleteMeSubscription(t *testing.T) {
	...
	newReq := func(id string) *http.Request {
		req := httptest.NewRequest(http.MethodDelete, "/api/v1/me/subscriptions/"+id, nil)
		req.Header.Set("X-Telegram-Init-Data", "valid")
		req.SetPathValue("id", id)
		return req
	}
...
func TestHandlersFailClosedWithoutACaller(t *testing.T) {
	...
	for name, pick := range authenticated {
		t.Run(name, func(t *testing.T) {
			...
			// never saw.
			pick(h)(rr, httptest.NewRequest(http.MethodGet, "/api/v1/me/anything", nil))
