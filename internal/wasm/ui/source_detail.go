...
func renderRateRow(r api.RateResponse) string {
...
func renderSubRow(s api.SubscriptionDetailResponse) string {
	notifiedAt := "—"
...
func renderDailyEventRow(e api.DailyEventResponse) string {
	return fmt.Sprintf(`<tr>
          <td>%s</td>
          <td>%s</td>
          <td>%s/%s</td>
